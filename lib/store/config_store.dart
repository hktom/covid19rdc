...
class ConfigStore extends ChangeNotifier {
  ...
  Map questions={
    ...
    'toux':'A t-elle une toux ou une augmentation de la toux habituelle ces derniers jours ?',

    'courbature':'A t-elle des douleurs musculaires ou des courbatures inhabituelles ces derniers jours ?',

    'gorge':'A t-elle un mal de gorge apparu ces derniers jours ?',

    'diarrhee':'A t-elle de la diarrhée ces dernièrs 24 heures (au moins 3 selles molles) ?',

    'fatigue':'A t-elle une fatigue inhabituelle ces derniers jours ?',

    'respiratoire':'A t-elle vu apparaître une gêne respiratoire ou une augmentation de son gêne respiratoire habituelle ? ',
    ...
    'defense':'A t-elle une maladie connue pour diminuer ses défenses immunitaires',

    'traitement':'Prend t un traitement immunosuppresseur ? C’est un traitement qui diminue vos défenses contre les infections. Voici quelques exemples : corticoïdes, méthotrexate,ciclosporine, tacrolimus, azathioprine, cyclophosphamide (liste non exhaustive). '
...
Map index={
  ...
  {
    if((input[0] || input[1]) && (input[1]||input[3]) && (input[2]||input[0]) && input[4]){

      resultTest="nous vous conseillons de rester à votre domicile et de contacter votre médecin en cas d’apparition de nouveaux symptômes. Vous pourrez aussi utiliser à nouveau l’application pour réévaluer vos symptômes.";

      }
      else
      {
         resultTest="Votre situation ne relève probablement pas du Covid-19. N’hésitez pas à contacter votre médecin en cas de doute. Vous pouvez refaire le test en cas de nouveau symptôme pour réévaluer la situation. Pour toute information concernant le Covid-19, composer le 222.";
      }
  ...
  void AlertDiagnostic({List<bool> input})
  {
    if((input[0] || input[1]) && (input[1]||input[3]) && (input[2]||input[0]) && input[4]){
      ...
      {
         resultTest="Sa situation ne relève probablement pas du Covid-19. N’hésitez pas à contacter votre médecin en cas de doute. Vous pouvez refaire le test en cas de nouveau symptôme pour réévaluer la situation. Pour toute information concernant le Covid-19, composer le 222.";
      }
