...
class _HomePageState extends State<HomePage> {
  ...
  Widget _renderGrid_one(){
    return Row(
      children: <Widget>[
        Expanded(child: _renderCardButton(label: "Confirmé 45", icon: Icons.local_hospital, colors: Colors.orange[400], link:"#"), flex: 1,),

         Expanded(child: _renderCardButton(label: "Guéris 1", icon: Icons.supervised_user_circle, colors: Colors.green[200], link:"#"), flex: 1,),

         Expanded(child: _renderCardButton(label: "Décès 3", icon: Icons.departure_board, colors: Colors.blue[200], link:"#"), flex: 1,),
  ...
  Widget _renderGrid_two(){
    return Row(
      children: <Widget>[
        Expanded(child: _renderCardButton(label: "Actif 41", icon: Icons.perm_identity, colors: Colors.red[400], link:"#"), flex: 1,),

         Expanded(child: _renderCardButton(label: "Despistage", icon: Icons.store_mall_directory, colors: Colors.purple[200], link:"/test_page"), flex: 1,),

         Expanded(child: _renderCardButton(label: "Signaler", icon: Icons.add_alert, colors: Colors.green[200], link:"/report_page"), flex: 1,),
  ...
  Widget _textTitle(label){
    return Text(
      label, style: TextStyle(fontWeight:FontWeight.bold, fontSize: 18, decorationStyle:TextDecorationStyle.solid),
    );
  }
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              SizedBox(width:150, child: Image.asset('assets/logo_stop_coronavirus_rdc.png')),
              SizedBox(height:20),
              _renderGrid_one(),
              SizedBox(height:20),
              _renderGrid_two(),
